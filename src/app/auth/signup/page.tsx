            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white text-sm outline-none placeholder:text-white/20 focus:border-[#4597b0]/50"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white/70 text-sm outline-none"
                >
                  <option>Admin</option>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={8}
                  className="w-full px-3 py-2.5 pr-10 rounded-lg bg-white/5 border border-white/10 text-white text-sm outline-none placeholder:text-white/20 focus:border-[#4597b0]/50"
                />

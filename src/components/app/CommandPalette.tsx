...
export default function CommandPalette() {
  ...
  const items: PaletteItem[] = [
    { id: "dashboard", label: "Dashboard", description: "View command center", icon: LayoutDashboard, action: () => router.push("/app/dashboard"), category: "Pages" },
    { id: "sources", label: "Sources", description: "Manage knowledge sources", icon: Database, action: () => router.push("/app/sources"), category: "Pages" },
    { id: "resolve", label: "Resolve", description: "Ask a question", icon: MessageSquare, action: () => router.push("/app/resolve"), category: "Pages" },
    { id: "foundry", label: "Foundry", description: "Create knowledge", icon: PenLine, action: () => router.push("/app/foundry"), category: "Pages" },
    { id: "health", label: "Health", description: "View health dashboard", icon: HeartPulse, action: () => router.push("/app/health"), category: "Pages" },
    { id: "feedback", label: "Feedback", description: "View feedback loop", icon: MessageCircle, action: () => router.push("/app/feedback"), category: "Pages" },
    { id: "workflows", label: "Workflows", description: "Manage automations", icon: GitBranch, action: () => router.push("/app/workflows"), category: "Pages" },
    { id: "analytics", label: "Analytics", description: "Resolution intelligence", icon: BarChart3, action: () => router.push("/app/analytics"), category: "Pages" },
    { id: "integrations", label: "Integrations", description: "Connection hub", icon: Plug, action: () => router.push("/app/integrations"), category: "Pages" },
    { id: "widget", label: "Widget Preview", description: "Embeddable designer", icon: Layout, action: () => router.push("/app/widget"), category: "Pages" },
    { id: "reports", label: "Reports", description: "Automated reports", icon: FileText, action: () => router.push("/app/reports"), category: "Pages" },

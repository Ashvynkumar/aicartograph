        ...
        <div className="bg-[#071319] p-4 text-[10px]">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <div className="text-white/50 text-[9px] font-medium mb-0.5">Active Issues</div>
              {[
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      <span className="text-white/75 text-[9px] font-medium">{issue.title}</span>
                      <span
              ...
              <div className="mt-1">
                <div className="text-white/50 text-[9px] font-medium mb-1.5">Action Items</div>
